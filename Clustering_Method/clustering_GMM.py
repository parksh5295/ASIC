...
def clustering_GMM_normal(data, X, max_clusters, aligned_original_labels, global_known_normal_samples_pca=None, threshold_value=0.3, num_processes_for_algo=1):
...
def clustering_GMM_full(data, X, max_clusters, aligned_original_labels, global_known_normal_samples_pca=None, threshold_value=0.3, num_processes_for_algo=1):
    gmm_specific_max_clusters = min(max_clusters, 50) # GMM/SGMM is tested up to 50
    after_elbow = Elbow_method(data, X, 'GMM', gmm_specific_max_clusters, num_processes_for_algo=num_processes_for_algo)
    n_clusters = after_elbow['optimal_cluster_n']
    parameter_dict = after_elbow['best_parameter_dict']
...
def clustering_GMM_tied(data, X, max_clusters, aligned_original_labels, global_known_normal_samples_pca=None, threshold_value=0.3, num_processes_for_algo=1):
    gmm_specific_max_clusters = min(max_clusters, 50) # GMM/SGMM is tested up to 50
    after_elbow = Elbow_method(data, X, 'GMM', gmm_specific_max_clusters, num_processes_for_algo=num_processes_for_algo)
    n_clusters = after_elbow['optimal_cluster_n']
    parameter_dict = after_elbow['best_parameter_dict']
...
def clustering_GMM_diag(data, X, max_clusters, aligned_original_labels, global_known_normal_samples_pca=None, threshold_value=0.3, num_processes_for_algo=1):
    gmm_specific_max_clusters = min(max_clusters, 50) # GMM/SGMM is tested up to 50
    after_elbow = Elbow_method(data, X, 'GMM', gmm_specific_max_clusters, num_processes_for_algo=num_processes_for_algo)
    n_clusters = after_elbow['optimal_cluster_n']
    parameter_dict = after_elbow['best_parameter_dict']
...
def clustering_GMM(data, X, max_clusters, GMM_type, aligned_original_labels, global_known_normal_samples_pca=None, threshold_value=0.3, num_processes_for_algo=1):
    if GMM_type == 'normal':
        predict_GMM_dict = clustering_GMM_normal(data, X, max_clusters, aligned_original_labels, global_known_normal_samples_pca=global_known_normal_samples_pca, threshold_value=threshold_value, num_processes_for_algo=num_processes_for_algo)
    elif GMM_type == 'full':
        predict_GMM_dict = clustering_GMM_full(data, X, max_clusters, aligned_original_labels, global_known_normal_samples_pca=global_known_normal_samples_pca, threshold_value=threshold_value, num_processes_for_algo=num_processes_for_algo)
    elif GMM_type == 'tied':
        predict_GMM_dict = clustering_GMM_tied(data, X, max_clusters, aligned_original_labels, global_known_normal_samples_pca=global_known_normal_samples_pca, threshold_value=threshold_value, num_processes_for_algo=num_processes_for_algo)
    elif GMM_type == 'diag':
        predict_GMM_dict = clustering_GMM_diag(data, X, max_clusters, aligned_original_labels, global_known_normal_samples_pca=global_known_normal_samples_pca, threshold_value=threshold_value, num_processes_for_algo=num_processes_for_algo)
    else:
